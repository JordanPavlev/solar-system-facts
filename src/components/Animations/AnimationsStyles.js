...
export const Mercury = styled(PlanetAnimation)`
    width: 100px;
    height: 100px;
...
export const Venus = styled(PlanetAnimation)`
    width: 130px;
    height: 130px;
...
export const Earth = styled(PlanetAnimation)`
    width: 175px;
    height: 175px;
...
export const Mars = styled(PlanetAnimation)`
    width: 220px;
    height: 220px;
...
export const Jupiter = styled(PlanetAnimation)`
    width: 370px;
    height: 370px;
...
export const Saturn = styled(PlanetAnimation)`
    width: 470px;
    height: 470px;
    animation: orbit 82.6952471456s linear infinite;
    z-index: 95;
...
export const Uranus = styled(PlanetAnimation)`
    width: 550px;
    height: 550px;
...
export const Neptune = styled(PlanetAnimation)`
    width: 660px;
    height: 660px;
...
export const RingsAsteroids = styled.div`
    position: absolute;
    top: 50%;
    left: 50%;
    ...
    border-color: #30314B;
    overflow: hidden;
    animation: orbit 19.9558282773s linear infinite;
